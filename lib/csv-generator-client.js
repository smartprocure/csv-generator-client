...
exports.download = exports.getLinkElement = exports.initSettings = exports.getData = undefined;

var _fp = __webpack_require__(7);
...
var _btoa = typeof btoa !== 'undefined' && btoa || typeof Buffer !== 'undefined' && function (s) {
  return Buffer.from(s).toString('base64');
};
var _window = typeof window !== 'undefined' && window || null;

// This is exported for unit testing purposes.
var getData = exports.getData = function getData(separator, dataArray) {
  return _fp2.default.flow(_fp2.default.map(function (row) {
    return row.join(separator);
  }), function (data) {
    return data.join('\r\n');
  }, function (data) {
    if (_fp2.default.has('navigator.msSaveOrOpenBlob', _window)) {
      return data;
...
var getLinkElement = exports.getLinkElement = function getLinkElement(_ref2) {
  ...
  if (_fp2.default.has('navigator.msSaveBlob', _window)) {
    linkElement.href = '#';
...
var download = exports.download = function download(_ref3) {
  ...
  if (_fp2.default.has('navigator.msSaveBlob', _window)) {
    ...
    var linkElement = getLinkElement({ settings: settings, fileName: fileName, dataArray: dataArray });
