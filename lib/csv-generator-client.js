...
exports.generateDownloader = exports.generateDownloadLinkElement = undefined;
...
var getData = function getData(separator) {
...
var _getLinkElement = function _getLinkElement(settings, fileName, dataArray) {
  var _initSettings = initSettings.apply(undefined, _toConsumableArray(args)),
...
var generateDownloadLinkElement = exports.generateDownloadLinkElement = window.navigator.msSaveBlob && _getLinkElement;

var generateDownloader = exports.generateDownloader = _fp2.default.curry(function (settings, fileName, dataArray) {
  var _initSettings2 = initSettings.apply(undefined, _toConsumableArray(args)),
  ...
  if (window.navigator.msSaveBlob) {
    ...
    var linkElement = _getLinkElement(settings, fileName, dataArray);
